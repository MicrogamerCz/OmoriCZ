			...
			if (action.isValid()) {
				...
				if(DataManager.isSkill(action.item())) {
					if(subject.mp < action.item().mpCost) {
						this._logWindow.push("addText", subject.name().toUpperCase() + " nemá dostatek ŠŤÁVY!");
...
(function($) {
	...
	DataManager.chapterNamesPerLanguage = [
		["???", "???", "???", "？？？"],
		["DEN STĚHOVÁNÍ", "引越しの日", "이삿날", "搬家当天"],
		["JEDEN DEN DO STĚHOVÁNÍ...", "あと1日……", "이삿날까지 하루 남음...", "还有一天……"],
		["DVA DNY DO STĚHOVÁNÍ...", "あと2日……", "이삿날까지 이틀 남음...", "还有两天……"],
		["TŘI DNY DO STĚHOVÁNÍ...", "あと3日……", "이삿날까지 사흘 남음...", "还有三天……"],
		["PROLOG", "プロローグ", "서장", "序章"]
	];
