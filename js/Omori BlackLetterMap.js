...
Sprite_OmoBlackLetterMap.prototype.createOverlaySprites = function() {
  ...
  bgBitmap.addLoadListener(() => {
    bgBitmap50.addLoadListener(() => {
      var mapData = [
        {name: 'LES SVĚTLUŠEK',   namePos: new Point(80, 195), rect: new Rectangle(0, 0, 193, 139), pos: new Point(111, 103),  blackSwitchId: 23, nameSwitchId: 30, blackSwitch50Id: 900 },
        ...
        {name: 'VĚTRNÍKOVÝ LES',  namePos: new Point(440, 240), rect: new Rectangle(350, 0, 99, 107), pos: new Point(471, 128),  blackSwitchId: 24, nameSwitchId: 31, blackSwitch50Id: 901 },
        {name: 'VESNICE KLÍČKOKRTKŮ', namePos: new Point(25, 340), rect: new Rectangle(450, 0, 94, 80), pos: new Point(54, 267),  blackSwitchId: 25, nameSwitchId: 32, blackSwitch50Id: 902 },
        {name: 'ROZLEHLÝ LES',  namePos: new Point(250, 300), rect: new Rectangle(0, 124, 640, 201), pos: new Point(-2, 143),  blackSwitchId: 26, nameSwitchId: 33, blackSwitch50Id: 903 },
        {name: 'HLUBOKÁ STUDNA',        namePos: new Point(450, 355), rect: new Rectangle(0, 326, 418, 113), pos: new Point(119, 366),  blackSwitchId: 27, nameSwitchId: 34, blackSwitch50Id: 904 },
        {name: 'POMERANČOVÁ POUŠŤ',     namePos: new Point(20, 55), rect: new Rectangle(545, 0, 122, 102), pos: new Point(31, 85),  blackSwitchId: 28, nameSwitchId: 35, blackSwitch50Id: 905 },
        {name: 'JINOSFÉRA',  namePos: new Point(450, 75), rect: new Rectangle(419, 326, 140, 209), pos: new Point(390, 21),  blackSwitchId: 29, nameSwitchId: 36, blackSwitch50Id: 906 },
      ]
