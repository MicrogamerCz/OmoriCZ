...
//=============================================================================
Window_Selectable.prototype.customCursorRectXOffset = function() { return 8; }　//矢印のX座標変更
Window_Selectable.prototype.customCursorRectYOffset = function() { return -4; }　//矢印のY座標変更
...
Window_OmoMenuHelp.prototype.standardFontSize = function() { return !$gameParty.inBattle() ? 15 : LanguageManager.getMessageData("XX_BLUE.Window_OmoMenuHelp").refresh_description_fontsize; };
...
Window_OmoMenuHelp.prototype.refresh = function() {
  ...
  if (this._item) {
    ...
    const itemfix = SceneManager._scene instanceof Scene_OmoMenuItem ? 4 : 0
...
Window_Message.prototype.wordwrapWidth = function(){
  ...
  return Window_Base.prototype.wordwrapWidth.call(this) - 20;
};
    ...
    win.update = function(animPhase) {
      if (animPhase == 2) {
        ...
        if (this.drawOpacity < 255) {
          ...
          win.contents.drawText(this.textToDraw, 0, -2, this.contents.width, this.contents.height, 'center');
        }
      } else if (animPhase == 4) {
        this.contents.clear();
        this.drawOpacity -= 4;
